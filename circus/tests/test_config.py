...
class TestConfig(TestCase):
    ...
    def test_issue310(self):
        '''
        https://github.com/mozilla-circus/circus/pull/310
    ...
    def test_issues665(self):
        '''
        https://github.com/mozilla-circus/circus/pull/665
    ...
    def test_empty_include(self, mock_logger_warn):
        """https://github.com/mozilla-circus/circus/pull/473"""
        try:
    ...
    def test_expand_vars(self):
        '''
        https://github.com/mozilla-circus/circus/pull/554
        '''

...
from tests.support import TestCircus, Process, async_poll_for
from tests.support import async_run_plugin as arp
...
fqn = 'tests.test_plugin_watchdog.run_dummy_watchdogged'
